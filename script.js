...
function formula() {
    ...
    var vMax = parseInt(document.getElementById("vMax").value);
    var aceleracao = parseInt(document.getElementById("aceleracao").value);

    //formula
    var resultado = 3 + (vMax / aceleracao) + ((((aceleracao * vMax) / aceleracao ** 2) / 2) - distancia) / vMax;

    document.getElementById("resultEX2").innerHTML = ("Resultado " + resultado + " segundos");
